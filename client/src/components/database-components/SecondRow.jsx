    ...
    return(
        <div id="journal" className="form-row" hidden={true}>
            ...
            <div className="form-group col-md-1">
                ...
                <input type="text" name="pg" id="pg" className="form-control" placeholder="pg" onChange={props.action} value={props.state.pg} />
            </div>
            <div className="form-group col-md-1 year">
                <label className="sr-only" htmlFor="sign">published year modifier sign</label>
                <select className="form-control" name="sign" onChange={props.action} value={props.state.sign} >
            ...
            <div className="form-group col-md-2 year" >
                ...
                <input type="number" className="form-control" name="year" id="year" min="1900" max="2019" step="1" placeholder="year" onChange={props.action} value={props.state.year} />
            </div>
        </div>
    );
}
